...
var onSignUp = function onSignUp(event) {
  ...
  if (document.getElementById('password-field').value !== document.getElementById('password-confirmation').value) {
    $.toast({
...
var addHandlers = function addHandlers() {
  ...
  $('#showOptionThree').on('click', function () {
    selection = 2;
  });
...
var store = __webpack_require__(5);
var showSurveysTemplate = __webpack_require__(20);
__webpack_require__(7);
__webpack_require__(8);
...
var showOneSuccess = function showOneSuccess(data) {
  ...
  twos = store.survey.responses.filter(function (x) {
    return x === 2;
  });
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
  ...
  return "\n\n  <div data-id=\""
    ...
    + " or "
    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.optionThree : stack1), depth0))
